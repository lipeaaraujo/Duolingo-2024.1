...
| RNF30 | 30 | [BS16](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [ST13](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | As lições do aplicativo devem ser interativas | Média Prioridade |
| RNF31 | 31 | [BS17](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [MM25](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais) | Deve existir um feedback imediato após a realização de uma questão | Média Prioridade |
| RNF32 | 32 | [BS18](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [ST16](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve possuir funcionalidades no modo off-line | Média Prioridade |
| RNF33 | 33 | [BS19](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [ST18](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais), [MM18](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais), [AP17](../ElicitacaodeRequisitos/protocolo.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve ser gamificado | Média Prioridade |
| RNF34 | 34 | [BS20](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais) | A maioria das funcionalidades devem ser gratuitas | Alta Prioridade |
| RNF35 | 35 | [BS21](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [MM20](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve suportar muitos usuários simultaneamente | Alta Prioridade |
| RNF36 | 36 | [BS22](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [MM23](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve apresentar uma navegação simples | Média Prioridade |
| RNF37 | 37 | [BS23](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [MM22](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve apresentar uma interface intuitiva | Média Prioridade |
| RNF38 | 38 | [BS24](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [ST12](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | As lições devem ser curtas e objetivas | Alta Prioridade |
| RNF39 | 39 | [BS26](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [ST14](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve estar disponível a qualquer horário e local | Alta Prioridade |
| RNF40 | 40 | [ST15](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve estar disponível em diversos tipos de dispositivos | Média Prioridade |
| RNF41 | 41 | [ST17](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve ser acessível para qualquer idade | Média Prioridade |
| RNF42 | 42 | [ST19](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve estar disponível em diversos idiomas | Alta Prioridade |
| RNF43 | 43 | [ST20](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve permitir a sincronização de contas em dispositivos diferentes | Baixa Prioridade |
| RNF44 | 44 | [MM21](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais) | As transações dentro da loja devem ser seguras | Alta Prioridade |
| RNF45 | 45 | [MM24](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais), [AP15](../ElicitacaodeRequisitos/protocolo.md#tabela-02-requisitos-nao-funcionais) | As lições devem ter conteúdo confiável e verificado | Alta Prioridade |
| RNF46 | 46 | [AP14](../ElicitacaodeRequisitos/protocolo.md#tabela-02-requisitos-nao-funcionais) | As mensagens de feedback devem ser claras e objetivas | Alta Prioridade |
| RNF47 | 47 | [AP16](../ElicitacaodeRequisitos/protocolo.md#tabela-02-requisitos-nao-funcionais) | O design do aplicativo deve ser padronizado | Média Prioridade |
...
| RF12  | 12  | [BS08](../ElicitacaodeRequisitos/brainstorm.md#tabela-01-requisitos-funcionais), [ST10](../ElicitacaodeRequisitos/storytelling.md#tabela-01-requisitos-funcionais) | O usuário deve ser capaz de monitorar seu progresso no curso             | M    |
...
| RNF30 | 30  | [BS16](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [ST13](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | As lições do aplicativo devem ser interativas                            | S    |
| RNF31 | 31  | [BS17](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [MM25](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais) | Deve existir um feedback imediato após a realização de uma questão       | S    |
| RNF32 | 32  | [BS18](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [ST16](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve possuir funcionalidades no modo off-line               | C    |
| RNF33 | 33  | [BS19](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [ST18](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais), [MM18](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais), [AP17](../ElicitacaodeRequisitos/protocolo.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve ser gamificado                                         | S    |
| RNF34 | 34  | [BS20](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais) | A maioria das funcionalidades devem ser gratuitas                        | M    |
| RNF35 | 35  | [BS21](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [MM20](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve suportar muitos usuários simultaneamente               | S    |
| RNF36 | 36  | [BS22](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [MM23](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve apresentar uma navegação simples                       | S    |
| RNF37 | 37  | [BS23](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [MM22](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve apresentar uma interface intuitiva                     | S    |
| RNF38 | 38  | [BS24](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [ST12](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | As lições devem ser curtas e objetivas                                   | S    |
| RNF39 | 39  | [BS26](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [ST14](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve estar disponível a qualquer horário e local            | S    |
| RNF40 | 40  | [ST15](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve estar disponível em diversos tipos de dispositivos     | S    |
| RNF41 | 41  | [ST17](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve ser acessível para qualquer idade                      | C    |
| RNF42 | 42  | [ST19](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve estar disponível em diversos idiomas                   | M    |
| RNF43 | 43  | [ST20](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve permitir a sincronização de contas em dispositivos diferentes | C    |
| RNF44 | 44  | [MM21](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais) | As transações dentro da loja devem ser seguras                           | M    |
| RNF45 | 45  | [MM24](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais), [AP15](../ElicitacaodeRequisitos/protocolo.md#tabela-02-requisitos-nao-funcionais) | As lições devem ter conteúdo confiável e verificado                      | M    |
...
| RF05 | 05 | [MM07](../ElicitacaodeRequisitos/observacao.md#tabela-01-requisitos-funcionais) | O perfil do usuário deve exibir informações importantes | Média Prioridade, C |
...
| RF28 | 28 | [AP06](../ElicitacaodeRequisitos/protocolo.md#tabela-01-requisitos-funcionais) | Permite pular ou adiar questões de fala e escuta | Média Prioridade, C |
...
| RNF30 | 30 | [BS16](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [ST13](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | As lições do aplicativo devem ser interativas | Média Prioridade, S |
| RNF31 | 31 | [BS17](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [MM25](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais) | Deve existir um feedback imediato após a realização de uma questão | Média Prioridade, S |
| RNF32 | 32 | [BS18](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [ST16](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve possuir funcionalidades no modo off-line | Média Prioridade, C |
| RNF33 | 33 | [BS19](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [ST18](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais), [MM18](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais), [AP17](../ElicitacaodeRequisitos/protocolo.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve ser gamificado | Média Prioridade, S |
| RNF34 | 34 | [BS20](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais) | A maioria das funcionalidades devem ser gratuitas | Alta Prioridade, M |
| RNF35 | 35 | [BS21](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [MM20](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve suportar muitos usuários simultaneamente | Alta Prioridade, S |
| RNF36 | 36 | [BS22](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [MM23](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve apresentar uma navegação simples | Média Prioridade, S |
| RNF37 | 37 | [BS23](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [MM22](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve apresentar uma interface intuitiva | Média Prioridade, S |
| RNF38 | 38 | [BS24](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [ST12](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | As lições devem ser curtas e objetivas | Alta Prioridade, S |
| RNF39 | 39 | [BS26](../ElicitacaodeRequisitos/brainstorm.md#tabela-02-requisitos-nao-funcionais), [ST14](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve estar disponível a qualquer horário e local | Alta Prioridade, S |
| RNF40 | 40 | [ST15](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve estar disponível em diversos tipos de dispositivos | Média Prioridade, S |
| RNF41 | 41 | [ST17](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve ser acessível para qualquer idade | Média Prioridade, C |
| RNF42 | 42 | [ST19](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve estar disponível em diversos idiomas | Alta Prioridade, M |
| RNF43 | 43 | [ST20](../ElicitacaodeRequisitos/storytelling.md#tabela-02-requisitos-nao-funcionais) | O aplicativo deve permitir a sincronização de contas em dispositivos diferentes | Baixa Prioridade, C |
| RNF44 | 44 | [MM21](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais) | As transações dentro da loja devem ser seguras | Alta Prioridade, M |
| RNF45 | 45 | [MM24](../ElicitacaodeRequisitos/observacao.md#tabela-02-requisitos-nao-funcionais), [AP15](../ElicitacaodeRequisitos/protocolo.md#tabela-02-requisitos-nao-funcionais) | As lições devem ter conteúdo confiável e verificado | Alta Prioridade, M |
| RNF46 | 46 | [AP14](../ElicitacaodeRequisitos/protocolo.md#tabela-02-requisitos-nao-funcionais) | As mensagens de feedback devem ser claras e objetivas | Alta Prioridade, M |
| RNF47 | 47 | [AP16](../ElicitacaodeRequisitos/protocolo.md#tabela-02-requisitos-nao-funcionais) | O design do aplicativo deve ser padronizado | Média Prioridade, S |
