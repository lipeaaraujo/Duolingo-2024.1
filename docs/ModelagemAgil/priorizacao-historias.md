...
|----|------------------------|------------|-------------|
| [US01](product-backlog.md#us01) | - [ ] O perfil deve permitir personalizar dados como nome, nome de usuário, avatar, telefone <br> - [ ] As mudanças devem ser refletidas imediatamente no perfil <br> <br> | Alta | Média |
| [US02](product-backlog.md#us02) | - [ ] O perfil deve apresentar informações importantes como dias de ofensiva, total de XP, divisão atual, troféis, amigos, seguidores e seguindo, cursos, conquistas <br> - [ ] O layout do perfil deve ser simples e organizado <br> - [ ] As informações do perfil devem sempre estar atualizadas | Média | Média |
| [US03](product-backlog.md#us03) | - [ ] O usuário deve poder enviar e receber solicitações de amizade <br> - [ ] O usuário deve poder compartilhar seu perfil e progresso em outras redes e por QR code <br> | Alta | Média |
| [US04](product-backlog.md#us04) | - [ ] Visualizar o perfil de um amigo <br> - [ ] Participar de missões de amigos, competir nas ligas e entre amigos <br> - [ ] Enviar presentes por meio das missões de amigos <br> - [ ] Compartilhar notificações de progresso e interagir com as notificações | Média | Alta |
| [US05](product-backlog.md#us05) | - [ ] Receber sugestões com base nos amigos, interesses e interações <br> - [ ] Poder visualizar o perfil do usuário sugerido <br> - [ ] As sugestões devem estar visíveis na interface de perfil | Baixa | Média |
| [US06](product-backlog.md#us06) | - [ ] O usuário deve poder cadastrar conta com email e senha <br> - [ ] O usuário deve ser capaz de visualizar e editar as informações pessoais <br> - [ ] O usuário deve ser capaz de excluir a conta permanentemente | Alta | Média |
| [US07](product-backlog.md#us07) | - [ ] O usuário deve ser capaz de acessar utilizando outras plataformas como Google e Facebook <br> - [ ] O usuário deve capaz de acessar usando as informações de uma conta registrada <br> - [ ] O usuário deve ser capaz de acessar em qualquer dispositivo compatível com o app | Alta | Média |
| [US08](product-backlog.md#us08) | - [ ] O usuário deve ser capaz de sair da conta com segurança <br> - [ ] Todos os tokens da sessão devem ser removidos ou inutilizados | Alta | Baixa |
| [US09](product-backlog.md#us09) | - [ ] O usuário deve ser capaz de acessar a mesma conta em dispositivos diferentes <br> - [ ] Os dados devem estar constantemente sincronizados <br> | Alta | Média |
| [US10](product-backlog.md#us10) | - [ ] O usuário deve ser capaz de salvar e excluir contas do mesmo dispositivo <br> - [ ] O usuário deve ser capaz de alternar entre as contas salvas <br> | Média | Média |
| [US11](product-backlog.md#us11) | - [ ] O aplicativo deve enviar notificações de lembretes diários, atualizações sobre o progresso na liga, as novidades do aplicativo e atualizações de amigos <br> - [ ] O aplicativo deve exibir as notificações enviadas | Média | Média |
| [US12](product-backlog.md#us12) | - [ ] O usuário deve ser capaz de ativar ou desativar individualmente as notificações de lembretes, sobre a liga, novidades e amigos <br> - [ ] O usuário deve ser capaz de definir a frequência dos lembretes e o horário para receber <br> O usuário deve ser capaz de ativar ou desativar as notificações sobre novos seguidores e atividade dos amigos | Alta | Baixa |
| [US13](product-backlog.md#us13) | - [ ] As lições devem ser interativas, curtas e objetivas <br> - [ ] As questões abranger exercícios de fala, leitura, escrita e escuta <br> - [ ] O conteúdo deve ser confiável e verificado <br> - [ ] O usuário deve ser capaz de realizar uma lição específica de seu conteúdo <br> - [ ] Ao concluir a lição o progresso do usuário deve ser atualizado | Alta | Alta |
| [US14](product-backlog.md#us14) | - [ ] O usuário deve ser capaz de fazer uma lição de revisão após concluir um nível <br> - [ ] O usuário deve ser capaz de refazer as questões incorretas durante uma lição <br> - [ ] O usuário deve ser capaz de revisar as histórias abordadas <br> - [ ] O usuário deve ser capaz de fazer uma lição de revisão da unidade | Alta | Média |
| [US15](product-backlog.md#us15) | - [ ] O usuário deve ser capaz de avançar em uma unidade ou seção realizando um teste <br> - [ ] O conteúdo do teste deve abranger todo o conteúdo da unidade ou seção <br> - [ ] O teste deve oferecer recompensas maiores | Alta | Baixa |
| [US16](product-backlog.md#us16) | - [ ] O feedback deve informar se o usuário acertou ou errou a questão, e no segundo caso apresentar a resposta correta - [ ] O feedback deve ser imediato após a realização da questão <br> - As mensagens de feedback devem ser claras e objetivas | Alta | Média |
| [US17](product-backlog.md#us17) | - [ ] O usuário deve receber a porcentagem de acertos, tempo gasto e a recompensa obtida <br> - [ ] A mensagem de desempenho deve aparecer logo após completar uma lição <br> - [ ] A mensagem de desempenho deve ser clara e objetiva | Média | Média |
| [US18](product-backlog.md#us18) | - [ ] O usuário deve ser capaz de visualizar a Trilha de Progresso, com as lições já realizadas e as próximas lições <br> - [ ] O usuário deve ser capaz de visualizar as unidades finalizadas em uma seção <br> - [ ] O layout da trilha deve ser claro e organizado | Alta | Média |
| [US19](product-backlog.md#us19) | - [ ] O usuário deve ser capaz de visualizar e realizar as histórias completadas <br> - [ ] As coleções devem estar constantemente atualizadas <br> - [ ] O usuários deve ser capaz de visualizar os erros mais recentes <br> - [ ] O usuário deve ser capaz de visualizar o número de palavras aprendidas | Média | Baixa |
...
| [US25](product-backlog.md#us25) | - [ ] O usuário deve ser capaz de competir nas ligas com os amigos <br> - [ ] O progresso nas ligas deve ser apresentado para ambos participantes | Alta | Baixa |
...
| [US27]product-backlog.md(#us27) | - [ ] O usuário deve ser capaz de visualizar e completar missões diárias e semanais <br> - [ ] O progresso nas missões deve ser apresentado em tempo real <br> - [ ] As recompensas pelas missões devem ser entregues automaticamente | Alta | Média |
...
| [US35](product-backlog.md#us35) | - [ ] O usuário deve ser recompensado ao completar desafios de ofensiva <br> - [ ] As recompensas devem ser entregues automaticamente ao completar os desafios <br> - [ ] O progresso do desafio deve ser exibido em tempo real | Alta | Baixa |
| [US36](product-backlog.md#us36) | - [ ] O usuário deve ser capaz de utilizar um item de bloqueio de ofensiva para evitar perder uma ofensiva <br> - [ ] O bloqueio deve ser ativado automaticamente ao perder um dia de estudo <br> - [ ] O progresso do bloqueio deve ser exibido no perfil | Baixa | Baixa |
...
| [US40](product-backlog.md#us40) | - [ ] O conteúdo deve ser adequado para diferentes idades <br> - [ ] O aplicativo deve ser facilmente utilizável por crianças e idosos | Alta | Baixa |
...
| [US42](product-backlog.md#us42) | - [ ] O usuário deve ser capaz de acessar o aplicativo offline para realizar lições e missões <br> - [ ] O progresso offline deve ser sincronizado automaticamente ao reconectar à internet <br> - [ ] A interface offline deve ser tão funcional quanto a online | Alta | Média |
