...
| [US03](product-backlog.md#us03) | - [ ] O usuário deve poder enviar e receber solicitações de amizade <br> - [ ] O usuário deve poder compartilhar seu perfil e progresso em outras redes e por QR code <br> | Média | Média |
...
| [US09](product-backlog.md#us09) | - [ ] O usuário deve ser capaz de acessar a mesma conta em dispositivos diferentes <br> - [ ] Os dados devem estar constantemente sincronizados <br> | Média | Média |
...
| [US12](product-backlog.md#us12) | - [ ] O usuário deve ser capaz de ativar ou desativar individualmente as notificações de lembretes, sobre a liga, novidades e amigos <br> - [ ] O usuário deve ser capaz de definir a frequência dos lembretes e o horário para receber <br> O usuário deve ser capaz de ativar ou desativar as notificações sobre novos seguidores e atividade dos amigos | Média | Baixa |
| [US13](product-backlog.md#us13) | - [ ] As lições devem ser interativas, curtas e objetivas <br> - [ ] As questões devem abranger exercícios de fala, leitura, escrita e escuta <br> - [ ] O conteúdo deve ser confiável e verificado <br> - [ ] O usuário deve ser capaz de realizar uma lição específica de seu conteúdo <br> - [ ] Ao concluir a lição o progresso do usuário deve ser atualizado <br> - [ ] Os áudios da lição podem ser reproduzidos quantas vezes o usuário desejar - <br> [ ] A velocidade do áudio da questão pode ser alterada <br> - [ ] Um novo vocabulário deve ser destacado <br> [ ] Questões de fala e escuta podem ser adiadas pelo usuário | Alta | Alta |
...
| [US16](product-backlog.md#us16) | - [ ] O feedback deve informar se o usuário acertou ou errou a questão, e no segundo caso apresentar a resposta correta <br>- [ ] O feedback deve ser imediato após a realização da questão <br> - [ ] As mensagens de feedback devem ser claras e objetivas | Alta | Média |
