...
| Episódios |  O **usuário** pega o celular.<br>O **usuário** abre o **Duolingo**.<br> Seleciona a aba de escolha de curso.<br> Seleciona o curso desejado.<br> Clica no botão de continuar.<br> Responde uma breve pesquisa.<br> O aplicativo abre a primeira **lição** do curso escolhido.  |
| Restrição  | O curso escolhido deve estar disponível na lista de cursos oferecidos pelo aplicativo **Duolingo** |
| Exceção  | O **usuário** pode não encontrar o idioma desejado.</br>Queda de internet antes de concluir o processo de escolha.<br> O aparelho celular não funcionar corretamente. |
...
| Objetivo  | o **usuário** deseja refazer um **lição** já concluida     |
...
| Restrição  |  A **lição** deve estar concluida anteriormente      |
| Exceção  | Queda de internet antes de concluir a **lição**.<br> O aparelho celular não funcionar corretamente.</br>A lição  não estar disponível para revisão, caso o conteúdo tenha sido alterado ou removido     |
...
| Atores  | O **usuário** do **Duolingo** |
| Episódios |O **usuário** deseja exclui a conta.</br>O **usuário** acessa as configurações da conta<br>Ele seleciona a opção de excluir a conta<br>O sistema solicita confirmação da exclusão<br>A conta é permanentemente excluída do sistema |
...
| Recursos  | Aplicativo **Duolingo**.<br> Dispositivo celulares e semelhantes.<br> Acesso à internet.       |
| Atores  | O **usuário** do **Duolingo**       |
| Episódios | O usuário deseja acompanhar seu progresso.<br>O **usuário** pega o celular.<br>O **usuário** abre o **Duolingo**.<br>  O **usuário** acessa a seção de progresso no perfil<br> Verifica o histórico de lições, pontuações e metas.       |
...
| Contexto  | Local: Na casa do Felipe <br> Pré-condições: Ter acesso a internet, estar logado em uma conta e ter o aplicativo instalado |
| Recursos  | Aplicativo **Duolingo**.<br>Dispositivo celulares e semelhantes.<br> Acesso à internet.|
| Atores  | O **usuário** do **Duolingo** |
...
| Exceção  | Queda de internet ao tentar acessar a aba de progresso.<br> O aparelho celular não funcionar corretamente.  |
...
| Exceção  | Configuração não disponível no app.<br>Queda de internet ao tentar acessar a aba de progresso.<br> O aparelho celular não funcionar corretamente. |
...
| Exceção  | O **usuário** estar com as **notificações** desabilitadas.</br> Aparelho sem conexão a internet. |
...
| Exceção  | Queda de internet durante a utilização do aplicativo, <br> O aparelho celular não funcionar corretamente, <br> O **usuário** não estar inscrito em um **curso**, <br> O **usuário** não estar participando de nenhuma **divisão**, <br> O usuário não ser capaz de realizar **lições** ou **missões** |
...
| Exceção  | Queda de internet durante a utilização do aplicativo, <br> O aparelho celular não funcionar corretamente, <br> O **usuário** não estar inscrito em um **curso**, <br>  |
...
| Exceção  | Queda de internet antes de concluir a navegação, <br> O aparelho celular não funcionar corretamente, <br> O **usuário** não conseguir localizar uma seção desejada na interface, <br> A interface ser confusa para o **usuário** |
...
| Recursos  | Aplicativo **Duolingo**, <br> Dispositivo celulares e semelhantes. <br> Acesso à internet. |
| Atores  | O **usuário** do **Duolingo** |
| Episódios | O **usuário** deseja escolher um idioma base no **Duolingo**, <br> O **usuário** pega o celular, <br>O **usuário** abre o **Duolingo**, <br> Seleciona a aba de escolha de idiomas, </br> Busca pelo idioma base desejado. </br> Seleciona o curso que deseja aprender, dentre os disponiveis no idioma base escolhido, </br> Clica no botão de continuar, <br> Responde uma breve pesquisa, <br> O aplicativo abre a primeira **lição** do curso escolhido. |
| Restrição  |  O curso que deseja estudar está no idioma base, <br> O idioma base está disponível no aplicativo |
...
Na Tabela 18 está detalhada a CN17, que descreve o processo de realizar o login em uma conta no Duolingo
...
| Objetivo  | Sair da **conta** atualmente **logada** dentro do aplicativo do **Duolingo** |
| Contexto  | Local: Em casa <br>  Pré-condições: Ter acesso a **internet** e estar **logado** em uma **conta** |
| Recursos  | Aplicativo **Duolingo**, <br> Dispositivo celulares e semelhantes. <br> Acesso à internet. |
| Atores  | O **usuário** do **Duolingo** |
| Episódios | O **usuário** deseja sair de sua conta no **Duolingo**, <br> O **usuário** pega o celular, <br>O **usuário** abre o **Duolingo**, <br> O **usuário** acessa a tela de **perfil**, </br> O **usuário** acessa as configurações no ícone, </br> O **usuário** seleciona a opção de sair da **conta**, </br> O app **Duolingo** faz **logoff** da conta do **usuário**, <br> O app **Duolingo** direciona para a tela de gerencia de **contas** |
| Restrição  | Não há |
